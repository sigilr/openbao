...
import (
	...
	dbMemcached "github.com/openbao/openbao/v2/internal/builtin/database/memcached"
...
func newRegistry() *registry {
	reg := &registry{
		...
		databasePlugins: map[string]databasePlugin{
			...
			"memcached-database-plugin":  {Factory: dbMemcached.New},
			...
			"remote-memcached-plugin":    {Factory: dbRemote.New("memcached-database-plugin")},
		},
