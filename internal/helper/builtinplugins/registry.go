...
import (
	...
	dbDocDB "github.com/openbao/openbao/v2/internal/builtin/database/documentdb"
...
func newRegistry() *registry {
	reg := &registry{
		...
		databasePlugins: map[string]databasePlugin{
			...
			"documentdb-database-plugin": {Factory: dbDocDB.New},
			...
			"remote-documentdb-plugin":   {Factory: dbRemote.New("documentdb-database-plugin")},
		},
