	...
	t.Run("typed", func(t *testing.T) {
		...
		if diff := deep.Equal(resp.Data, map[string]any{
			"keys": []string{
				...
				"postgresql-database-plugin", "qdrant-database-plugin", "redis-database-plugin",
				"remote-cassandra-plugin", "remote-influxdb-plugin", "remote-mysql-plugin",
				"remote-postgres-plugin", "remote-qdrant-plugin", "remote-redis-plugin", "remote-valkey-plugin",
