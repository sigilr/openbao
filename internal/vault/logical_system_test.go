...
func TestSystemBackend_PluginCatalog_List(t *testing.T) {
	...
	t.Run("typed", func(t *testing.T) {
		...
		if diff := deep.Equal(resp.Data, map[string]any{
			"keys": []string{
				"cassandra-database-plugin", "hazelcast-database-plugin", "influxdb-database-plugin", "mysql-aurora-database-plugin",
				...
				"remote-cassandra-plugin", "remote-hazelcast-plugin", "remote-influxdb-plugin", "remote-mysql-plugin",
	...
	t.Run("untyped", func(t *testing.T) {
		...
		require.Equal(t, resp.Data, map[string]any{
			...
			"detailed": []map[string]any{{
				...
				"name":               "hazelcast-database-plugin",
				"builtin":            true,
				"deprecation_status": "supported",
				"type":               "database",
				"version":            "v2.0.0+builtin.bao",
