...
func TestSystemBackend_PluginCatalog_List(t *testing.T) {
	...
	t.Run("typed", func(t *testing.T) {
		...
		if diff := deep.Equal(resp.Data, map[string]any{
			"keys": []string{
				"cassandra-database-plugin", "db2-database-plugin", "influxdb-database-plugin", "mysql-aurora-database-plugin",
				...
				"remote-cassandra-plugin", "remote-db2-plugin", "remote-influxdb-plugin", "remote-mysql-plugin",
