...
request them from OpenBao, and use OpenBao's [leasing mechanism](../../concepts/lease.mdx)
...
|------------------------------------------------------------|--------------------------|---------------|--------------|------------------------|------------------|
| [Cassandra](cassandra.mdx)       | Yes                      | Yes           | Yes          | Yes                    | password         |
| [Druid](druid.mdx)               | No                       | Yes           | Yes          | Yes                    | password         |
| [Elasticsearch](elasticsearch.mdx) | Yes                    | Yes           | Yes          | Yes                    | password         |
| [etcd](etcd.mdx)                 | Yes                      | Yes           | Yes          | Yes                    | password         |
| [Ignite](ignite.mdx)             | No                       | Yes           | Yes          | Yes                    | password         |
| [InfluxDB](influxdb.mdx)         | Yes                      | Yes           | Yes          | Yes                    | password         |
| [Kafka](kafka.mdx)               | Yes                      | Yes           | Yes          | Yes                    | password         |
| [Microsoft SQL Server](mssql.mdx) | Yes                     | Yes           | Yes          | Yes                    | password         |
| [Milvus](milvus.mdx)             | No                       | Yes           | Yes          | Yes                    | password         |
| [MongoDB](mongodb.mdx)           | Yes                      | Yes           | Yes          | Yes                    | password         |
| [MySQL/MariaDB](mysql-maria.mdx) | Yes                      | Yes           | Yes          | Yes                    | password         |
| [Neo4j](neo4j.mdx)               | Yes                      | Yes           | Yes          | Yes                    | password         |
| [Oracle](oracle.mdx)             | Yes                      | Yes           | Yes          | Yes                    | password         |
| [PostgreSQL](postgresql.mdx)     | Yes                      | Yes           | Yes          | Yes                    | password         |
| [Qdrant](qdrant.mdx)             | No                       | Yes           | No           | Yes                    | API key          |
| [RabbitMQ](rabbitmq.mdx)         | Yes                      | Yes           | Yes          | Yes                    | password         |
| [SAP HANA](hana.mdx)             | Yes                      | Yes           | Yes          | Yes                    | password         |
| [Solr](solr.mdx)                 | No                       | Yes           | Yes          | Yes                    | password         |
| [Valkey](valkey.mdx)             | Yes                      | Yes           | Yes          | No                     | password         |
| [Weaviate](weaviate.mdx)         | No                       | Yes           | No           | Yes                    | API key          |

## Custom plugins

This secrets engine allows custom database types to be run through the exposed
plugin interface. Please see the [custom database plugin](custom.mdx)
...
and passwords. The [credential_type](/api-docs/secret/databases)
and [credential_config](/api-docs/secret/databases/) parameters
