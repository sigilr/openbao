...
export const AVAILABLE_PLUGIN_TYPES = [
  ...
  {
    value: 'hazelcast-database-plugin',
    displayName: 'Hazelcast (static-only)',
    fields: [
      { attr: 'plugin_name' },
      { attr: 'name' },
      { attr: 'verify_connection', show: false },
  ...
  {
    value: 'remote-hazelcast-plugin',
    displayName: 'Hazelcast (Remote, static-only)',
    fields: [
      { attr: 'plugin_name' },
      { attr: 'name' },
      { attr: 'verify_connection', show: false },
